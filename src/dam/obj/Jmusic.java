...
public class Jmusic {
	...
	public static void deleteRepresentante() throws IOException { // Metodo para eliminar los representantes.
		listarRG();
		System.out.println("�Que representante desea borrar?");
	...
	public static void modificarRepresentante() {
		...
		listarRG();
		System.out.println("�Que representante desea modificar?");
		int id = entrada.controlaInt();
		modificar = modificar;
		listaRepresentante.edit(modificar);
		System.out.println("Inserte el nuevo nombre: ");
		int modificar = entrada.controlaInt();
		JOptionPane.showMessageDialog(null, "El grupo "+listaRepresentante.get(modificar).getNombre()+" ha sido modificado satisfactoriamente");
